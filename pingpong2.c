...
int main() {
    int width = 81, height = 25;
    char mas[height][width];
    int x1 = 12, x2 = 12, y1 = 3, y2 = 76, ysetka = 40;
    ...
    if (key != 'o' ){
        while (first != 7 && second != 7) {
            ...
            //first = 0;
            printf("\n!!!CONGRATULATIONS PLAYER 1 IS A WINNER!!!\n");
            return 0;
        } if (second == 7) {
            //second = 0;
            printf("\n!!!ELINA IS A WINNER, TAKE A PRETTY GARNET JUICE, LOVE YOU!!!\n");
            return 0;
        }
    }
